                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                        ...
                                        data-nomorhp="{{ $item->NO_HP }}" data-email="{{ $item->EMAIL }}"
                                        data-bagian="{{ $item->nama_bagian }}" data-jabatan="{{ $item->nama_jabatan }}"
                                        data-status="{{ $item->STATUS_KARYAWAN }}" data-nik="{{ $item->NIK }}"
                                        data-tptlahir="{{ $item->TEMPAT_LAHIR }}"
                                        data-tgllahir="{{ $item->formatted_tanggal_lahir }}"
                                        data-alamatktp="{{ $item->ALAMAT_KTP }}"
                                        data-alamattgl="{{ $item->ALAMAT_TINGGAL }}" data-outlet="{{ $item->nama_toko }}"
                                        data-masakontrak="{{ $item->MASA_KONTRAK }}"
                                        data-awalkontrak="{{ $item->formatted_awal_kontrak }}"
                                        data-akhirkontrak="{{ $item->formatted_akhir_kontrak }}"
                                        data-saldocuti="{{ $item->SALDO_CUTI }}"
                                        data-tglgabung="{{ $item->formatted_tanggal_gabung }}"
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        ...
                                        data-status="{{ $item->STATUS_KARYAWAN }}" data-nik="{{ $item->NIK }}"
                                        data-tptlahir="{{ $item->TEMPAT_LAHIR }}"
                                        data-tgllahir="{{ $item->formatted_tanggal_lahir_edit }}"
                                        data-alamatktp="{{ $item->ALAMAT_KTP }}"
                                        data-alamattgl="{{ $item->ALAMAT_TINGGAL }}" data-outlet="{{ $item->nama_toko }}"
                                        data-masakontrak="{{ $item->MASA_KONTRAK }}"
                                        data-awalkontrak="{{ $item->formatted_awal_kontrak_edit }}"
                                        data-akhirkontrak="{{ $item->formatted_akhir_kontrak_edit }}"
                                        data-saldocuti="{{ $item->SALDO_CUTI }}"
                                        data-tglgabung="{{ $item->formatted_tanggal_gabung_edit }}"
                                        data-id="{{ $item->ID_KARYAWAN }}">
                                        Edit
                                    </button>
                                </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editKaryawanForm" action="/posteditkaryawan" method="POST">
                            ...
                            <div class="form-group mb-2">
                                <label for="modalNik"><strong>NIK:</strong></label>
                                <input type="text" class="form-control" id="modalNik" name="nik"
                                    value="">
                            </div>
                            <div class="form-group mb-2">
                                <label for="modalNomorHp"><strong>Nomor HP:</strong></label>
                                <input type="text" class="form-control" id="modalNomorHp" name="nomor_hp"
                                    value="">
                            </div>
                            <div class="form-group mb-2">
                                <label for="modalEmail"><strong>Email:</strong></label>
                            ...
                            <div class="form-group mb-2">
                                <label for="modalTptLahir"><strong>Tempat Lahir:</strong></label>
                                <input type="text" class="form-control" id="modalTptLahir" name="tempat_lahir"
                                    value="">
                            </div>
                            <div class="form-group mb-2">
                                <label for="modalTglLahir"><strong>Tanggal Lahir:</strong></label>
                            ...
                            <div class="form-group mb-2">
                                <label for="modalAwalKontrak"><strong>Awal Kontrak:</strong></label>
                                <input type="date" class="form-control" id="modalAwalKontrak" name="awal_kontrak"
                                    value="">
                            </div>
                            <div class="form-group mb-2">
                                <label for="modalAkhirKontrak"><strong>Akhir Kontrak:</strong></label>
                                <input type="date" class="form-control" id="modalAkhirKontrak" name="akhir_kontrak"
                                    value="">
                            </div>
                            <div class="form-group mb-2">
                                <label for="modalAlamatKtp"><strong>Alamat KTP:</strong></label>
                            ...
                            <div class="form-group mb-2">
                                <label for="modalSaldoCuti"><strong>Saldo Cuti:</strong></label>
                                <input type="text" class="form-control" id="modalSaldoCuti" name="saldo_cuti"
                                    value="">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
